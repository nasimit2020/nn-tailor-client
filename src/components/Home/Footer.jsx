...
const Footer = () => {
    return (
        <div className=''>
            ...
            <footer className="footer px-10 py-4 border-t bg-purple-50 text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p>NN-TAILOR Industries Ltd. <br />Providing reliable tech since 1992</p>
                </div>
